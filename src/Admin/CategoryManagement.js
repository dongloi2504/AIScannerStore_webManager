...
import { getCategory, createCategory, updateCategory, deleteCategory } from "../ServiceApi/apiCategory";
    ...
    <div className={`page-container ${isSidebarOpen ? "sidebar-open" : "sidebar-closed"}`}>
      ...
      <div className="content">
        <DataTable
          ...
          filters={[
            { label: "Category Name", value: filters.categoryName },
            { label: "Category ID", value: filters.categoryId },
            { label: "Category Description", value: filters.description },
          ]}
          setFilters={(index, value) => {
            const filterKeys = ["categoryName", "categoryId", "description"];
